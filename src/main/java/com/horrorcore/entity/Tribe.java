...
public class Tribe {
    ...
    private static final long FEED_COOLDOWN = SimulationConfig.FEED_COOLDOWN_MS;
    ...
    public static void formNewTribe(World world) {
        ...
        if (availableDigimon.size() >= SimulationConfig.MIN_DIGIMON_FOR_TRIBE) {
            ...
            for (int i = 0; i < SimulationConfig.INITIAL_TRIBE_MEMBERS - 1 && !availableDigimon.isEmpty(); i++) {
